...
- Version 3.00 is under development, which supports 3D Boolean operation, 3D mesh refinement, better and faster 3D mesh visualization, and better function API. The development progress is around 90%. I couldn't find spare time to polish functions and write tutorials. I may release it in November.
